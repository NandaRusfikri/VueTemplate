  ...
  <div>
      ...
      <v-card>
        ...
        <v-card-text>
          <v-row>
            ...
            <v-col cols="12" sm="6">
              <v-list-item-subtitle class="grey--text"
                >Status Pembayaran</v-list-item-subtitle
              >
              <v-list-item-title class="headline2 mb-1 black--text">{{
            ...
            <v-col cols="12" sm="6">
              <v-list-item-subtitle class="grey--text"
                >Note Detail</v-list-item-subtitle
              >
              <v-list-item-title class="headline2 mb-1 black--text">{{
            ...
            <v-col cols="12" sm="6">
              <v-list-item-subtitle class="grey--text"
                >Nama Pembeli</v-list-item-subtitle
              >
              <v-list-item-title class="headline2 mb-1 black--text">{{
            ...
            <v-col cols="12" sm="6">
              <v-list-item-subtitle class="grey--text"
                >Tanggal Pembelian</v-list-item-subtitle
              >
              <v-list-item-title class="headline2 mb-1 black--text">{{
            ...
            <v-col cols="12" sm="6">
              <v-list-item-subtitle class="grey--text"
                >Metode Pembayaran</v-list-item-subtitle
              >
              <v-list-item-title class="headline2 mb-1 black--text">{{
            ...
            <v-col cols="12" sm="6">
              <v-list-item-subtitle class="grey--text"
                >Jenis Iklan</v-list-item-subtitle
              >
              <v-list-item-title class="headline2 mb-1 black--text">{{
          ...
          <v-row>
            <v-col cols="12" sm="6">
              <v-list-item-subtitle class="grey--text"
                >Nama Bank</v-list-item-subtitle
              >
              <v-list-item-title class="headline2 mb-1 black--text">{{
            ...
            <v-col cols="12" sm="6">
              <v-list-item-subtitle class="grey--text"
                >Nama Pemilik Rekening</v-list-item-subtitle
              >
              <v-list-item-title class="headline2 mb-1 black--text">{{
            ...
            <v-col cols="12" sm="6">
              <v-list-item-subtitle class="grey--text"
                >No. Rekening</v-list-item-subtitle
              >
              <v-list-item-title class="headline2 mb-1 black--text">{{
            ...
            <v-col cols="12" sm="6">
              <v-list-item-subtitle class="grey--text"
                >Tanggal Pengajuan</v-list-item-subtitle
              >
              <v-list-item-title class="headline2 mb-1 black--text">{{
                TransaksiDetail.created_at | dateTimeFormat
              }}</v-list-item-title>
    ...
    <v-dialog v-model="dialog.Tolak" persistent max-width="500px">
      <v-card>
        <form>
          ...
          <v-card-actions>
            <div class="flex-grow-1"></div>
            <v-btn color="teal" outlined @click="dialog.Tolak = false"
              >Cancel</v-btn
            >
            <v-btn outlined @click="OnTolak(TransaksiDetail.id)">Tolak</v-btn>
          </v-card-actions>
        </form>
      </v-card>
    </v-dialog>
    ...
    <v-dialog v-model="dialog.Terima" persistent max-width="500px">
      <v-card>
        ...
        <v-card-subtitle>
          Yakin Menerima Pembayaran ini ?
        </v-card-subtitle>

        <v-card-actions>
          <div class="flex-grow-1"></div>
          <v-btn outlined color="teal" @click="dialog.Terima = false"
            >Cancel</v-btn
          >
          <v-btn outlined @click="OnKonfirmasi(TransaksiDetail.id)"
            >Terima</v-btn
          >
        </v-card-actions>
      </v-card>
