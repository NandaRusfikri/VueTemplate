    ...
    <v-dialog v-model="dialog.Tolak" persistent max-width="500px">
      <v-card>
        <v-toolbar dark color="red darken-1">
          ...
          <div class="flex-grow-1"></div>
          <v-btn icon dark @click="dialog.Tolak = false">
            <v-icon>mdi-close</v-icon>
          </v-btn>
        </v-toolbar>
        <v-select
    ...
    <v-dialog v-model="dialog.Terima" persistent max-width="500px">
      <v-card>
        <v-toolbar dark color="teal darken-3">
          <v-toolbar-title>Apakah Anda Yakin Terima Moderasi?</v-toolbar-title>
          <div class="flex-grow-1"></div>
          <v-btn icon dark @click="dialog.Terima = false">
            <v-icon>mdi-close</v-icon>
          </v-btn>
        </v-toolbar>
